...
import ProjectsM from './projectsM/page'
import ProjectsW from './projectsW/page'
import ProjectP from './projectsP/page'
            ...
            <div className="container px-5 py-12 mx-auto">
                ...
                <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                    ...
                    <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
                        ...
                        <Link href='../projectMain/projectsW' className="mt-3 text-green-400 hover:text-black hover:font-bold inline-flex items-center">
                    ...
                    <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
                        ...
                        <Link href='../projectMain/projectsP' className="mt-3 text-green-400 hover:text-black hover:font-bold inline-flex items-center">
                            <button className="flex mx-auto mt-20 font-semibold  text-black bg-green-400 border-0 py-2 px-8 focus:outline-none  hover:bg-black hover:text-green-500 rounded-full text-base md:mt-0">
                                Explore
                                <svg
                                    fill="none"
                    ...
                    <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
                        ...
                        <Link href='../projectMain/projectsM' className="mt-3 text-green-400 hover:text-black hover:font-bold inline-flex items-center">
                            <button className="flex mx-auto mt-20 font-semibold  text-black bg-green-400 border-0 py-2 px-8 focus:outline-none  hover:bg-black hover:text-green-500 rounded-full text-base md:mt-0">
                                Explore
                                <svg
                                    fill="none"
